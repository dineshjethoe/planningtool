...
GO
PRINT N'Creating [Employee].[AssignedTasks]...';
...
GO
PRINT N'Creating [Employee].[DF_AssignedTasks_IsDeleted]...';


GO
ALTER TABLE [Employee].[AssignedTasks]
    ADD CONSTRAINT [DF_AssignedTasks_IsDeleted] DEFAULT ((0)) FOR [IsDeleted];
...
GO
PRINT N'Creating unnamed constraint on [Employee].[AssignedTasks]...';


GO
ALTER TABLE [Employee].[AssignedTasks]
    ADD DEFAULT 0 FOR [IsAllDay];
